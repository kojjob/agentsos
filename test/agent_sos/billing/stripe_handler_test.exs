defmodule AgentSos.Billing.Workers.StripeHandlerTest do
  ...
  describe "checkout.session.completed" do
    test "creates subscription for the organisation" do
      ...
      {:ok, [subscription]} = AgentSos.Billing.list_subscriptions()
  ...
  describe "customer.subscription.updated" do
    test "updates subscription status" do
      ...
      {:ok, updated} = Ash.get(AgentSos.Billing.Subscription, subscription.id)
  ...
  describe "customer.subscription.deleted" do
    test "marks subscription as canceled" do
      ...
      {:ok, canceled} = Ash.get(AgentSos.Billing.Subscription, subscription.id)
  ...
  describe "invoice.payment_succeeded" do
    test "creates invoice with paid status" do
      ...
      {:ok, invoices} = AgentSos.Billing.list_invoices()
