defmodule AgentSos.NotificationsTest do
  use AgentSos.DataCase, async: true

  alias AgentSos.Notifications.{Notification, EmailLog}
  ...
  describe "PubSub broadcast" do
    test "broadcasts notification to user channel" do
      Phoenix.PubSub.subscribe(AgentSos.PubSub, "user_notifications:test-user-id")

      AgentSos.Notifications.broadcast_to_user("test-user-id", %{
        type: :team_invite,
        title: "Test"
      })
