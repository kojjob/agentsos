...
config :agent_sos, AgentSos.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "agent_sos_test#{System.get_env("MIX_TEST_PARTITION")}",
  pool: Ecto.Adapters.SQL.Sandbox,
  pool_size: System.schedulers_online() * 2

# Oban: manual mode for assert_enqueued/refute_enqueued in tests
config :agent_sos, Oban, testing: :manual
...
config :agent_sos, AgentSos.Mailer, adapter: Swoosh.Adapters.Test
